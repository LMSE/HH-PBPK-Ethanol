...
% multi = [60 14; 120 14; 180 14]; %time, g
%multi = [60 .25*74.5; 120 .25*74.5; 180 .25*74.5];
multi = [];
n = size(multi,1);
...
aLiver = 1;     %amount of reaction in Liver (1 is 100%)
...
%This is from EtOH_ACALD_Explore.m
...
% Plot_Graphs;
AUC(x, y(:,2)) %uM*min/L
AUC(x, y(:,19)*1000) %uM*min/L

%end
%leg = legend ('ALDH2.1 - WT','ALDH2.2 - E504K','ALDH2.3 - I41V','ALDH2.4 - P92T','ALDH2.5 - T244M','ALDH2.6 - V304M','ALDH2.7 - R338W')
%title(leg, 'ALDH2 Isoforms')
