...
%all reactions (non-slack) that involve EtOH, found by using Excel search for EtOH containing metabolites
...
MMMax = 5000;
male.ub(strmatch('Liver_ALCD2if',male.rxns))=MMMax; %no need because FBA solves this
male.lb(strmatch('Liver_ALCD2if',male.rxns))=MMMax;
%total metabolism, calculated based on liver metabolism rates assuming that
%the liver metabolizes 90-95% of all ethanol
